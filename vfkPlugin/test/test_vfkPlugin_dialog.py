...
from MainApp import vfkPluginDialog

from utilities import get_qgis_app
QGIS_APP = get_qgis_app()


class vfkPluginDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = vfkPluginDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(vfkPluginDialogTest)
